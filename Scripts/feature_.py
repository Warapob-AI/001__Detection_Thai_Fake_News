...
def Save_Vectorizer(fake_news, true_news):
    joblib.dump(fake_news, '001__Detection_Thai_Fake_News/Model/fake_news_features.pkl')
    joblib.dump(true_news, '001__Detection_Thai_Fake_News/Model/true_news_features.pkl')
